...
+ See [Unlocking LUKS TPM2](Security/Unlock_LUKS_TPM2.md) for detailed instructions.
+ **Update:** I have published a simple CLI uility, `update-pcrs`, in its own Github repo, [here](https://github.com/benhaube/Update-LUKS-PCRs-script). 
...
+ See [Setup SSH Login Email Notification](Security/Setup_SSH_Login_Email_Notification.md) for detailed instructions.
...
+ See [Defining Terminal Aliases](Terminal/Defining_Terminal_Aliases.md) for detailed instructions.
+ See [My Terminal Aliases](Terminal/My_Terminal_Aliases.md) for a list of aliases I use on all of my GNU/Linux PCs and servers. 
